...
int main()
{
    try
    {
        ...
        cout << "[find_min_using_approx_deriv] rosen solution:\n" << starting_point << endl;
        ...
        cout << endl << "[L-BFGS] rosen solution: \n" << starting_point << endl;

        starting_point = -94, 5.2;
        find_min_using_approximate_derivatives(lbfgs_search_strategy(10),
                                               objective_delta_stop_strategy(1e-7),
                                               rosen, starting_point, -1);
        cout << "[L-BFGS approx] rosen solution: \n"<< starting_point << endl;
        ...
        cout << endl << "[LBFGS with constraints] constrained rosen solution: \n" << starting_point << endl;
        ...
        cout << endl << "[LBFGS with constraints approx] constrained rosen solution: \n" << starting_point << endl;
        ...
        find_min(newton_search_strategy(rosen_hessian),
                 ...
                 starting_point,
                 -1);
        cout << "[find_min with second deriv] rosen solution: \n"<< starting_point << endl;
        ...
        cout << "[find_min_trust_region] rosen solution: \n"<< starting_point << endl;
        ...
        find_min_using_approximate_derivatives(cg_search_strategy(),
                                               objective_delta_stop_strategy(1e-7),
                                               test_function(target), starting_point, -1);
        cout << "[conj gradient] test_function solution:\n" << starting_point << endl;
        ...
        cout << "[BOBYQA] test_function solution:\n" << starting_point << endl;
